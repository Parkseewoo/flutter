...
class MyApp extends StatelessWidget {
  static const String _title = 'Widget Sample';
  @override
...
class _WidgetSampleState extends State<WidgetApp> {
  String sum = '';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('220116 Calculator by PSW'),
      ),
      body: Container(
        child: Center(
          child: Column(
  ...
  void initState(){
    ...
    _buttonText = _dropDownMenuItems[1].value;
  }
}